...
?>
  ...
  <a href="eventreg.php"><input class="btn btn-primary mb-2" type="submit" name="create" value="Add Events"></a> 
...
<td><textarea  id="exampleFormControlTextarea1" col="4" rows="3" style="z-index:1"><?php echo $row['details'];?> </textarea></td>
<td>
<a href="eventedit.php?id=<?php echo $row['event_id'] ?>"><input class="btn btn-success btn-sm mb-2" type="submit" name="create" value="Update"></a>
<a href="deleteevent.php?id=<?php echo $row['event_id'] ?>"><input class="btn btn-danger btn-sm mb-2" type="submit" name="create" value="Delete"></a></button>
</td>
