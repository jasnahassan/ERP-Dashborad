...
<div class="logbutt">
  ...
  <a href="tutor.php"><input class="btn btn-primary mb-2" type="submit" name="create" value="Register"></a> 
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration" id="data">
...
while($row=mysqli_fetch_assoc($result))
{
    ?>
<tr>
<td><?php echo $row['tutor_idgen'];?> </td>
<td><?php echo $row['tutor_name'];?> </td>
<td><?php echo $row['tutor_email'];?> </td>
<td><?php echo $row['password'];?> </td>
<td><?php echo $row['joindate'];?> </td>
<td><?php echo $row['tutor_image'];?> </td>
<td><?php echo $row['work_professional'];?> </td>
<td><?php echo $row['availability'];?> </td>
<td><?php echo $row['id_proof'];?> </td>
<td><?php echo $row['id_image'];?> </td>
<td><?php echo $row['tutor_phone'];?> </td>
<td><?php echo $row['tutor_edu_quali'];?> </td>
<td><?php echo $row['tutor_experience'];?> </td>
...
<td><button type="button" class="btn btn-link"><a href="activeupdate.php?id=<?php echo $row['tutor_id'] ?>&s=<?php if ($row['status']==1)
            {
                echo 0;
            }else{ 
                echo 1;
...
<td><a href="tutoredit.php?id=<?php echo $row['tutor_id'] ?>">

<input class="btn btn-success btn-sm mb-2" type="submit" name="create" value="update"></a>
</td><!-- <td><?php// echo $row['tutor_edu_quali'];?> </td> -->

<!-- <td><textarea class="form-control" id="exampleFormControlTextarea1" rows="1"><?php// echo $row['Message'];?> </textarea></td>
<td><button type="button" class="btn btn-secondary">Pendding</button>
<button type="button" class="btn btn-success">Confirm</button>
<button type="button" class="btn btn-danger">Delete</button> -->
<!-- </td> -->


  <!--<td><a href="readmore.php"id="<?php ///echo $row['id'];  ?>">Readmore</a></td>  -->
  <!-- <td><a href="readmore.php?id=<?php //echo $row['id'] ?>">ReadMore</a></td> -->
</tr>
<?php
}
