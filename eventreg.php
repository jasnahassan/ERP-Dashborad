...
<form class="p-5" action="eventtosql.php"  method="POST" name="eventreg">
  <div class="form align-items-center">
    <div class="col-auto">
      <label class="sr-only" for="inlineFormInput">Event Name</label>
      <input type="text" name="ev_name" class="form-control mb-2" id="ev_name" placeholder="Event Name">
    </div>
    <div class="col-auto">
      <label class="sr-only" for="inlineFormInput">Date</label>
      <input type="Date" name="ev_date" class="form-control mb-2" id="ev_date" placeholder="Date">
    </div>
     <div class="col-auto">
      <label class="sr-only" for="inlineFormInput">Category</label>
      <input type="text" name="ev_category" class="form-control mb-2" id="ev_category" placeholder="category">
    </div>
     <div class="col-auto">
      <label class="sr-only" for="inlineFormInput"><textarea class="form-control" id="exampleFormControlTextarea1" rows="1">Details</textarea></label>
      <input type="text" name="ev_details" class="form-control mb-2" id="ev_details" placeholder="Details">
    </div>
...
<!-- content -->
    ...
    ***********************************-->
    ...
    <script src="event_reg_validate.js"></script>
