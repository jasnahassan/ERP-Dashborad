                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration" id="data" method="POST">
  

  
 <!-- <table class="table table-striped zero-configuration"id="data" method="POST" > -->
    <thead>
      <tr>
        <th>Name</th>
        <th>Email</th>
...
<td><textarea  id="exampleFormControlTextarea1" rows="3"><?php echo $row['Message'];?> </textarea></td>
<td><?php echo $row['update_status'];?> </td>
<td>

<form  action="dateupdate.php?id=<?php echo $row['Id'] ?>" method="POST">
  <select name="Color">
  <option value="confirm">confirm</option>
  <option value="followup">followup</option>
  <option value="reject">reject</option>
</select>
<input type="submit" class="btn btn-success btn-sm mt-2" name="submit" value="ok"></td>
</form>
