...
<form action="courseupdate.php?id=<?php echo $id ?> " method="POST">
  <div class="form align-items-center">
    ...
    <div class="col-auto">
      ...
      <input type="text" name="course" class="form-control mb-2" id="inlineFormInput" value="<?=$data['course_name'];?>">
    </div>
    <div class="col-auto">
      <label class="sr-only" for="inlineFormInput">Duration</label>
      <input type="text" name="duration" class="form-control mb-2" id="inlineFormInput" value="<?=$data['course_duration'];?>">
    </div>
     <div class="col-auto">
      <label class="sr-only" for="inlineFormInput">fee</label>
      <input type="text" name="fee" class="form-control mb-2" id="inlineFormInput" value="<?=$data['course_fee'];?>">
    </div>
