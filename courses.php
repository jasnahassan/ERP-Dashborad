...
<div class="logbutt">
  ...
  <a href="coursesreg.php"><input class="btn btn-primary mb-2" type="submit" name="create" value="Add courses"></a> 
...
?>
<tr>
<td><?php echo $row['course_idgen'];?> </td>
...
<td><a href="coursesedit.php?id=<?php echo $row['course_id'] ?>"><input class="btn btn-success btn-sm mb-2" type="submit" name="create" value="Update">
<a href="deletecourse.php?id=<?php echo $row['course_id'] ?>"><input class="btn btn-danger btn-sm mb-2" type="submit" name="create" value="Delete"></button>
</td>
