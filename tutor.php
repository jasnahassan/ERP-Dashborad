                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="index2.php">Home 1</a></li>
  ...
  .sizeissue{
    padding: 25px;
                        ...
                        <div class="card">
                            <!-- <div class="card-body">
                                ...
                                <!--     <form class="form-valide p-4 col-lg-10" action="regtosql.php" method="post" name="tutorreg" enctype="multipart/form-data"> -->
                                    <form class="form-valide p-4 col-lg-10" name="tutorreg" action="regtosql.php" method="post" enctype="multipart/form-data">
                                    <div class="form-group row">

                                       <label class="col-lg-4 col-form-label" for="val-email">Profile picture <span class="text-danger">*</span>
                                            </label>
                                        ...
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <br> <input type="file" name="fileToUpload_id" id="fileToUpload_id">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                       ...
                                       <!--  <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            <label class="col-lg-4 col-form-label"><a href="#">Working professional</a>  <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-8">
                                                <label class="css-control css-control-primary css-checkbox" for="val-terms">
                                                    <input type="checkbox" class="css-control-input" id="val-pro" name="val-pro" value="Fulltime"> <span class="css-control-indicator"></span> YES</label>&nbsp
                                                    <label class="css-control css-control-primary css-checkbox" for="val-terms">
                                                    <input type="checkbox" class="css-control-input" id="val-pro" name="valpro" value="Morning"> <span class="css-control-indicator"></span> NO</label>&nbsp
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="date" class="form-control" id="val-number" name="val-number" placeholder="DD/MM/YEAR">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="date" class="form-control" id="val-range" name="val-range" placeholder="DD/MM/YEAR">
                                            </div>
                                        </div>
                                        <div class="form-group row">
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; Designed & Developed by <a href="https://themeforest.net/user/quixlab">Calibroz</a> 2019</p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
    ...
    <script src="js/styleSwitcher.js"></script>
        <script src="tutorreg_validation.js"></script>
