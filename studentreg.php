                        ...
                        <div class="card">
                            <!-- <div class="card-body">
                                ...
                                <!--     <form class="form-valide p-4 col-lg-10" action="regtosql.php" method="post" name="tutorreg" enctype="multipart/form-data"> -->
                                    <form class="form-valide p-4 col-lg-10" name="tutorreg" action="studenttosql.php" method="post" enctype="multipart/form-data">
                                         <div class="form-group row">

                                       <label class="col-lg-4 col-form-label" for="val-email">Profile picture <span class="text-danger">*</span>
                                            </label>

                                         &nbsp<input type="file" name="fileToUpload" id="fileToUpload">
                                    </div>
                                       ...
                                       <div class="form-group row">
                                            <label class="col-lg-4 col-form-label"><a href="#">Gender</a>  <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-8">
                                                <label class="css-control css-control-primary css-checkbox" for="val-terms">
                                                    <input type="checkbox" class="css-control-input" id="val-gender" name="val-gender" value="Fulltime"> <span class="css-control-indicator"></span>Male</label>&nbsp
                                                    <label class="css-control css-control-primary css-checkbox" for="val-terms">
                                                    <input type="checkbox" class="css-control-input" id="val-gender" name="val-gender" value="Morning"> <span class="css-control-indicator"></span>Female</label>&nbsp
                                                    <label class="css-control css-control-primary css-checkbox" for="val-terms">
                                                    <input type="checkbox" class="css-control-input" id="val-gender" name="val-gender" value="Evening"> <span class="css-control-indicator"></span> others</label>&nbsp
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-address" name="val-address" placeholder="current Address">
                                            </div>
                                        </div>
