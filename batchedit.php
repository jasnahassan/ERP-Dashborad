...
<form action="batchupdate.php?id=<?php echo $id ?> " method="POST">
      <?php
  ...
  <div class="form align-items-center">
    <div class="col-auto">
      ...
      <input type="text" name="bt_name" class="form-control mb-2" id="inlineFormInput" value="<?=$data['batch_name'];?>">
    </div>
    <div class="col-auto">
      <label class="sr-only" for="inlineFormInput">No of students</label>
      <input type="text" name="bt_stno" class="form-control mb-2" id="inlineFormInput" value="<?=$data['no_of_students'];?>">
    </div>
     <div class="col-auto">
      <label class="sr-only" for="inlineFormInput">start time</label>
      <input type="text" name="bt_stime" class="form-control mb-2" id="inlineFormInput" value="<?=$data['start_time'];?>">
    </div>
     <div class="col-auto">
      <label class="sr-only" for="inlineFormInput">End time</label>
      <input type="text" name="bt_etime" class="form-control mb-2" id="inlineFormInput" value="<?=$data['end_time'];?>">
    </div>
     <div class="col-auto">
      <label class="sr-only" for="inlineFormInput">Batch time</label>
      <input type="text" name="bt_btime" class="form-control mb-2" id="inlineFormInput" value="<?=$data['batch_time'];?>">
    </div>
     <div class="col-auto">
      <label class="sr-only" for="inlineFormInput">Tutor Id</label>
      <input type="text" name="bt_tid" class="form-control mb-2" id="inlineFormInput" value="<?=$data['tutor_id'];?>">
    </div>
     <div class="col-auto">
      <label class="sr-only" for="inlineFormInput">Status</label>
      <input type="text" name="bt_status" class="form-control mb-2" id="inlineFormInput" value="<?=$data['batch_status'];?>">
    </div>
     <div class="col-auto">
      <label class="sr-only" for="inlineFormInput">Course Id</label>
      <input type="text" name="bt_cid" class="form-control mb-2" id="inlineFormInput" value="<?=$data['course_id'];?>">
    </div>
