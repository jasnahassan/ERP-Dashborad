...
<form action="eventupdate.php?id=<?php echo $id ?>"  method="POST">
      <?php
  ...
  <div class="form align-items-center">
    <div class="col-auto">
      ...
      <input type="text" name="ev-name" class="form-control mb-2" id="inlineFormInput"  value="<?=$data['event_name'];?>">
    </div>
    <div class="col-auto">
      <label class="sr-only" for="inlineFormInput">Date</label>
      <input type="Date" name="ev-date" class="form-control mb-2" id="inlineFormInput"  value="<?=$data['eventdate'];?>">
    </div>
     <div class="col-auto">
      <label class="sr-only" for="inlineFormInput">Category</label>
      <input type="text" name="ev-category" class="form-control mb-2" id="inlineFormInput"  value="<?=$data['category'];?>">
    </div>
     <div class="col-auto">
      ...
      <input type="text" name="ev-details" class="form-control mb-2" id="inlineFormInput"  value="<?=$data['details'];?>">
    </div>
