...
<form  class="p-5" action="coursetosql.php"  method="post" name="coursereg">
  <div class="form align-items-center">
    <div class="col-auto">
      <label class="sr-only" for="inlineFormInput">course Name</label>
      <input type="text" name="course" class="form-control mb-2" id="course" placeholder="Course Name">
    </div>
    <div class="col-auto">
      <label class="sr-only" for="inlineFormInput">Duration</label>
      <input type="text" name="duration" class="form-control mb-2" id="duration" placeholder="Duration">
    </div>
     <div class="col-auto">
      <label class="sr-only" for="inlineFormInput">Fee</label>
      <input type="text" name="fee" class="form-control mb-2" id="fee" placeholder="Fee">
    </div>
...
<!-- content -->
    ...
    ***********************************-->
    ...
    <script src="coursesreg_validation.js"></script>
