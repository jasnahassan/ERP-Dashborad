...
<head>
    ...
    <title>Calibroz - ERP  Admin Dashboard </title>
    <!-- Favicon icon -->
...
<div class="logbutt">
  ...
  <a href="studentreg.php"><input class="btn btn-primary mb-2" type="submit" name="create" value="Register"></a> 
...
while($row=mysqli_fetch_assoc($result))
{
    ?>
<tr>
<td><?php echo $row['student_idgen'];?> </td>
...
<td><?php echo $row['id_proof_photo'];?> </td>
...
<td>
<button type="button" class="btn btn-link"><a href="activestudent.php?id=<?php echo $row['student_id'] ?>&s=<?php if ($row['status']==1)
            {
                echo 0;
            }else{ 
                echo 1;
...
<td>
 <?php
  if ($row['status']==1)
    {
    ?>
    <a href="studentedit.php?id=<?php echo $row['student_id'] ?>">
