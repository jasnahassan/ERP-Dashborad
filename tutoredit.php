...
<head>
    ...
    <title>Calibroz-ERP Dashboar</title>
    <!-- Favicon icon -->
        ...
        ***********************************-->
           <div class="nav-header" style="background-color: white">
            <div class="brand-logo" class="mb-2">
                <a href="index2.html">
                    <b class="logo-abbr"><img src="images/logocalib.png" alt=""> </b>
                    <span class="logo-compact"><img src="./images/logocalib.png" alt=""></span>
               ...
               <!--  <div class="header-left">
                ...
                <div class="header-right">
                    <ul class="clearfix">
                        ...
                        <a>Hai <?php echo $_SESSION['user']; ?></a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <div class="row">
   <div class="small-12 medium-2 large-2 columns portpic">
     <div class="circle">
       <!-- User Profile Image -->
     ...
     <div class="p-image">
       <!-- <i class="fa fa-camera upload-button"></i> -->
        <input class="file-upload" name="val-image" type="file" accept="image/*"/>
     </div>
  </div>
</div>
                                    <form class="form-valide" action="tutorupdate.php?id=<?php echo $id ?>" method="POST">
                                           <?php
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="val-username" value="<?=$data['tutor_name'];?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-email" name="val-email" value="<?=$data['tutor_email'];?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="password" class="form-control" id="val-password" name="val-password" value="<?=$data['password'];?>">
                                            </div>
                                        </div>
                                       <!--  <div class="form-group row">
                                       ...
                                       <!--  <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-phoneus" name="val-phoneus" value="<?=$data['tutor_phone'];?>">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-pro">Working proffesional <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="valpro" name="val-pro" value="<?=$data['work_professional'];?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-exp" name="val-exp" value="<?=$data['tutor_experience'];?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="date" class="form-control" id="val-number" name="val-number" value="<?=$data['doj'];?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label"><a href="#">Availability</a>  <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-8">
                                                <label class="css-control css-control-primary css-checkbox" for="val-terms">
                                                    <input type="checkbox" class="css-control-input" id="val-terms" name="val-terms" value="Fulltime"> <span class="css-control-indicator"></span> Fulltime</label>&nbsp
                                                    <label class="css-control css-control-primary css-checkbox" for="val-interms">
                                                    <input type="checkbox" class="css-control-input" id="val-terms" name="val-terms" value="Morning"> <span class="css-control-indicator"></span> Morning</label>&nbsp
                                                    <label class="css-control css-control-primary css-checkbox" for="val-terms">
                                                    <input type="checkbox" class="css-control-input" id="val-terms" name="val-terms" value="Evening"> <span class="css-control-indicator"></span> Evening</label>&nbsp
                                                    <label class="css-control css-control-primary css-checkbox" for="val-terms">
                                                    <input type="checkbox" class="css-control-input" id="val-terms" name="val-terms" value="Saturday"> <span class="css-control-indicator"></span> Saturday</label>&nbsp
                                                    <label class="css-control css-control-primary css-checkbox" for="val-terms">
                                                    <input type="checkbox" class="css-control-input" id="val-terms" name="val-terms" value="Sunday"> <span class="css-control-indicator"></span> Sunday</label>&nbsp
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="date" class="form-control" id="val-range" name="val-range" value="<?=$data['joindate'];?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <label class="css-control css-control-primary css-checkbox" for="val-terms">
                                                    <input type="checkbox" class="css-control-input" id="val-terms" name="val-interms" value="1"> <span class="css-control-indicator"></span> I agree to the terms</label>
                                            </div>
                                        </div>
                                        <div class="form-group row">
