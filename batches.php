...
<div class="logbutt">
  ...
  <a href="batchreg.php"><input class="btn btn-primary mb-2" type="submit" name="create" value="Add Batches"></a> 
  ...
  <!-- <div  style="overflow-x:auto;"> -->
   ...
   <!-- <table class="table table-striped zero-configuration"id="data" > -->
    <thead>
      <tr>
        <th>Batch Name</th>
        <th>Batch Id</th>
...
<td><?php echo $row['batch_idgen'];?> </td>
<td><?php echo $row['no_of_students'];?> </td>
<td><?php echo $row['start_time'];?> </td>
<td><?php echo $row['end_time'];?> </td>
<td><?php echo $row['batch_time'];?> </td>
<td><?php echo $row['tutor_id'];?> </td>
<td><?php echo $row['batch_status'];?> </td>
<td><?php echo $row['course_id'];?> </td>

<td><a href="batchedit.php?id=<?php echo $row['batch_id'] ?>"><input class="btn btn-success btn-sm mb-2" type="submit" name="create" value="Update"></td>
<td><a href="deletebatch.php?id=<?php echo $row['batch_id'] ?>"><input class="btn btn-danger btn-sm mb-2" type="submit" name="create" value="Delete">
</td>



<!-- <td><textarea class="form-control" id="exampleFormControlTextarea1" rows="1"><?php echo $row['Message'];?> </textarea></td>colo
<td><button type="button" class="btn btn-secondary">Pending</button>
