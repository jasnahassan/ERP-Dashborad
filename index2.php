                    ...
                    <ul class="clearfix">
                        ...
                        <li class="icons dropdown"><a href="javascript:void(0)" data-toggle="dropdown">
                                ...
                                <!-- <span class="badge badge-pill gradient-2">3</span> -->
                                 <p>Hi Welcome </p> <br>&nbsp&nbsp&nbsp
            ...
            <div class="container-fluid mt-3">
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-1">
                            <div class="card-body">
                                <h3 class="card-title text-white">No of Enquiries</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white">500</h2>
                                    <p class="text-white mb-0">Jan - Aug 2019</p>
                                </div>
                                <span class="float-right display-5 opacity-5"><i class="fa fa-search-plus"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                            <div class="card-body">
                                <h3 class="card-title text-white">No of Tutors</h3>
                                <div class="d-inline-block">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3">
                            <div class="card-body">
                                <h3 class="card-title text-white">No of Batches</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white">5</h2>
                                    <p class="text-white mb-0">Jan - Aug 2019</p>
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-4">
                            <div class="card-body">
                                <h3 class="card-title text-white">No of Students</h3>
                                <div class="d-inline-block">
                                ...
                                <div class="card">
                                    <div class="card-body pb-0 d-flex justify-content-between">
                                     <!--    <div>
                                            ...
                                            <p>Total Enquiries of the Month</p>
                                            <h3 class="m-0">555</h3>
                                        </div> -->
                                        <div>
                                            <ul>
                ...
                <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="card">
                                <!-- <div class="card-body">
                                    <h4 class="card-title">Enquiry Summary</h4>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="card card-widget">
                                <!-- <div class="card-body">
                                    <h5 class="text-muted">Enquiry Overview </h5>
                                    <h2 class="mt-4">5680</h2>
                                    <span>Total enquiry</span>
                                    <div class="mt-4">
                                        <h4>30</h4>
                                        <h6>Online Enquiries <span class="pull-right">30%</span></h6>
                                    ...
                                    <div class="mt-4">
                                        <h4>50</h4>
                                        <h6 class="m-t-10 text-muted">Offline Enquiries <span class="pull-right">50%</span></h6>
                                        <div class="progress mb-3" style="height: 7px">
                                    ...
                                    <div class="mt-4">
                                        <h4>20</h4>
                                        <h6 class="m-t-10 text-muted">Direct Enquiries <span class="pull-right">20%</span></h6>
                                        <div class="progress mb-3" style="height: 7px">
